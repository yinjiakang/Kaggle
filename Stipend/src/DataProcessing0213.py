...
test_library = pd.read_csv('../data/final_test/library_final_test.txt', header = None)
...
go_library_num.to_csv('../data/input/library0213.csv', index = True)


#read dorm
train_dorm = pd.read_csv('../data/train/dorm_train.txt', header = None)
train_dorm.columns = ['ID','DORM_TIME', 'IN_OUT']
test_dorm = pd.read_csv('../data/final_test/dorm_final_test.txt', header = None)
...
train_test_dorm.to_csv('../data/analysis/full_train_test_dorm0213.csv', index = False)
...
not_normal.to_csv('../data/input/not_normal0213.csv')